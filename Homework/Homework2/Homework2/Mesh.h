...
public:
	CWallMeshDiffused(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList
		*pd3dCommandList, float fWidth = 80.0f, float fHeight = 80.0f, float fDepth = 100.0f,
		XMFLOAT4 xmf4StartColor = XMFLOAT4(1.0f, 1.0f, 1.0f, 0.0f), 
		XMFLOAT4 xmf4EndColor = XMFLOAT4(1.0f, 0.0f, 0.0f, 0.0f));
...
public:
	CBulletMeshDiffused(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList
		*pd3dCommandList, float fWidth = 5.0f, float fHeight = 5.0f, float fDepth = 5.0f,
		XMFLOAT4 xmf4Color = XMFLOAT4(1.0f, 0.79f, 0.5f, 0.0f));
