...
#define MAX_PLAYER_MISSILE 8
#define COOLTIME_PLAYER_RELOAD 0.7
...
public:
	...
	virtual bool ReadyToFire() { return m_fReloadTime > COOLTIME_PLAYER_RELOAD; }
	...
	bool CollisionTestWithTerrain(void *pContext);

	CGameObject* GetMissile();
	void SetMissile(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList,
...
protected:
	...
	CGameObject					m_missiles[MAX_PLAYER_MISSILE];
};
