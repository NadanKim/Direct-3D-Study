...
D3D12_RASTERIZER_DESC CShader::CreateRasterizerState()
{
	...
	d3dRasterizerDesc.CullMode = D3D12_CULL_MODE_BACK; // BACK, FRONT
...
void CShader::CreateShaderVariables(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	//::gnCbvSrvDescriptorIncrementSize = pd3dDevice->GetDescriptorHandleIncrementSize(
	//	D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV); =>이거 아무것도 안하는데 왜 있었지
