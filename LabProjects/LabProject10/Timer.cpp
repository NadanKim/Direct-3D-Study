...
{
	// Performance Frequency가 있는 경우 컴퓨터의 Performance Counter를 사용한다.
	...
	// Performance Frequency가 없는 경우 멀티미디어 타이머를 사용한다.
	else
	{
...
{
	if (m_bStopped) return(float(((m_nStopTime - m_nPausedTime) - m_nBaseTime) * m_fTimeScale));
